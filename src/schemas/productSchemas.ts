...
import { CurrencyCode } from "@/components/ui/currency-select";
...
export const mobileProductSchema = baseProductSchema.extend({
  ...
  main_camera_type: z.string().optional(),
  selfie_camera_type: z.string().optional(),
  ...
  selfie_camera: z.string().optional(),
