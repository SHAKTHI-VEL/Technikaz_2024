...
import { MobileSpecsSection } from "./form-sections/MobileSpecsSection";
import { AdditionalSpecsSection } from "./form-sections/AdditionalSpecsSection";
import { LaptopAdditionalSpecsSection } from "./form-sections/LaptopAdditionalSpecsSection";
            ...
            <form className="space-y-8">
              <div className="grid gap-8">
                <div className="space-y-6">
                  ...
                  {selectedType === 'laptop' ? (
                    <>
                      <SpecificationsSection form={form as any} productType={selectedType} />
                      <Separator />
                      <LaptopAdditionalSpecsSection form={form as any} productType={selectedType} />
                    </>
                  ) : (
                    <>
                      <MobileSpecsSection form={form as any} productType={selectedType} />
                      <Separator />
                      <AdditionalSpecsSection form={form as any} productType={selectedType} />
                    </>
                  )}
                  <Separator />
                  <ImageSection 
