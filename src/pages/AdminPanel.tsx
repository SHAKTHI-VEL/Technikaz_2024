...
export default function AdminPanel() {
  ...
  // Content creator only sees the blog creation tab and drafts
        ...
        {showCategories ? (
          ...
          <Tabs defaultValue="analytics" className="space-y-6">
            ...
            <TabsContent value="drafts" className="space-y-4">
              <h2 className="text-xl font-semibold text-left">Blog Drafts</h2>
              <div className="bg-white rounded-lg shadow-lg p-6">
                <DraftsList />
              </div>
            </TabsContent>
            ...
            <TabsContent value="newsletter" className="space-y-4">
              <h2 className="text-xl font-semibold text-left">Newsletter Subscribers</h2>
              <NewsletterSubscribers />
            </TabsContent>

            <TabsContent value="enquiries" className="space-y-4">
              <h2 className="text-xl font-semibold text-left">Manage Enquiries</h2>
              <EnquiriesManager />
            </TabsContent>
